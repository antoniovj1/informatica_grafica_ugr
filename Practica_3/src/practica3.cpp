...
if(tipo == 'C'){
    cubo.draw(modo,0,0,1,1,0,0,2);
} else if(tipo == 'P') {
    piramide.draw(modo,0,0,1,1,0,0,2);
} else if(tipo == 'O') {
    objply.draw(modo,0,0,1,1,0,0,2);
} else if(tipo == 'R') {
    revolucion.draw(modo,0,0,1,1,0,0,2);
} else if(tipo == 'D'){
  c.draw(modo,0,0,1,1,0,0,2,rotC,rotCu,rotP);
}
glutPostRedisplay();
}
...
void normal_keys(unsigned char Tecla1,int x,int y){
  char teclaAux = Tecla1;
  Tecla1 = toupper(Tecla1);

  if (Tecla1=='Q') exit(0);
  else{
    if(Tecla1 == 'P' || Tecla1 == 'C' || Tecla1 == 'O' || Tecla1 == 'R' || Tecla1 == 'D')
      tipo =Tecla1;
    else if(teclaAux == 'Z'){
      if(rotC <= c.getMaxCab()+2 )
      rotC = rotC+2;
    }
    else if(teclaAux == 'z'){
      if(rotC >= -1*c.getMaxCab()+2 )
      rotC = rotC-2;
    }
    else if(teclaAux == 'Y'){
      if(rotCu <= c.getMaxCu()+2 )
      rotCu = rotCu+2;
    }
    else if(teclaAux == 'y'){
      if(rotCu >= -1*c.getMaxCu()+2 )
      rotCu = rotCu-2;
    }
    else if(teclaAux == 'X'){
      if(rotP <= c.getMaxPi()+2 )
      rotP = rotP+2;
    }
    else if(teclaAux == 'x'){
      if(rotP >= -1*c.getMaxPi()+2 )
      rotP = rotP-2;
    }
    else
      modo = Tecla1-48;
...
/*  if (argc != 3){
  ...
  cout << "\t\t**  D = Droide        **" << endl;
  cout << "\t\t**--------------------**" << endl;
  cout << "\t\t** Z/z = Mover cabeza **" << endl;
  cout << "\t\t** Y/y = Mover Cuerpo **" << endl;
  cout << "\t\t** X/x = Mover Pierna **" << endl;
  cout << "\t\t**--------------------**" << endl;
  cout << "\t\t**  1 = Ajedrez       **" << endl;
  cout << "\t\t**  2 = Sólido        **" << endl;
  cout << "\t\t**  3 = Aristas       **" << endl;
